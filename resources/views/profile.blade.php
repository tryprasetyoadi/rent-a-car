            ...
            <div class="header">
                ...
                <div class="update-form">
                    ...
                    <form action="{{ route('updateUser') }}" method="post">
                        ...
                        <input type="text" class="fform-control @error('username') is-invalid @enderror" name="username" id="textfield3" placeholder="UserID"><br>
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="textfield1" name="email" placeholder="Email"><br>
                        <input type="password" class="form-control @error('password') is-invalid @enderror" id="textfield4" name="password" placeholder="Password"><br>
